...
export interface Homestay {
  ...
  bookedDates: string[]; // ISO date strings of unavailable dates
}
    ...
    reviewsList: [
      {
        ...
        date: 'January 2026',
        rating: 5,
        comment: 'Maya and her family are incredible hosts. The cultural evening with traditional dance was a highlight of our trip. The food was amazing and plentiful!',
        helpful: 19,
      },
      {
        id: 2,
        ...
        date: 'December 2025',
        rating: 4,
        comment: 'Beautiful location, authentic experience. The trek to get here is worth it. Only wish we could have stayed longer. Will definitely return!',
        helpful: 14,
      },
    ],
    ...
    reviewsList: [
      {
        ...
        date: 'January 2026',
        rating: 5,
        comment: 'The sunrise here is simply unbelievable. Eight Himalayan peaks visible from the terrace! Bikash is incredibly knowledgeable about the mountains and local ecology.',
        helpful: 32,
      },
      {
        id: 2,
        ...
        date: 'December 2025',
        rating: 5,
        comment: 'Love the sustainable approach. Great food, comfortable rooms, and the views are world-class. The guided nature walk was educational and enjoyable.',
        helpful: 21,
      },
    ],
    ...
    reviewsList: [
      {
        ...
        date: 'January 2026',
        rating: 5,
        comment: 'The Tharu dance performance was magical! Ram and his family are wonderful hosts. The jungle safari arranged by them was excellent value.',
        helpful: 16,
      },
      {
        id: 2,
        ...
        date: 'November 2025',
        rating: 4,
        comment: 'Great cultural experience and perfect location for Chitwan. The food was delicious and different from typical Nepali food. Basic but authentic accommodation.',
        helpful: 11,
      },
    ],
    ...
    reviewsList: [
      {
        ...
        date: 'January 2026',
        rating: 5,
        comment: 'Heaven on earth! So peaceful after the chaos of Kathmandu. Sunita is a wonderful host and her cooking is incredible. The sunrise boat ride was magical.',
        helpful: 22,
      },
      {
        id: 2,
        ...
        date: 'December 2025',
        rating: 5,
        comment: 'We extended our stay twice! The cottage is simple but has everything you need. The lake views are breathtaking and it is so quiet and peaceful.',
        helpful: 17,
      },
    ],
    ...
    reviewsList: [
      {
        ...
        date: 'January 2026',
        rating: 5,
        comment: 'Staying here was like living in a museum, but with all the comforts! Rajendra is incredibly knowledgeable about Newari culture. The pottery class was unforgettable.',
        helpful: 28,
      },
      {
        id: 2,
        ...
        date: 'December 2025',
        rating: 5,
        comment: 'Exceptional heritage property. The wood carvings are stunning and the location is perfect. Walking through the ancient streets at dawn was magical.',
        helpful: 19,
      },
    ],
